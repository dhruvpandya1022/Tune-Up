											 ...
											 <!---->
											  <div class="col-md-4 player">
													<div class="audio-player">
														<audio id="audio-player" class="msc" controls="controls">
					...
					<!--//pop-up-box -->
						<div class="albums">
								<div class="tittle-head">
									...
									<a href="Tuneup.php"><h4 class="tittle">See all</h4></a>
									<div class="clearfix"> </div>
								</div>
...
<!-- ---------------------------------------------------------------- -->
						...
						?>
							...
							<div class="col-md-3 content-grid">
								<a id="pos" href="#"><img src="<?= $row['image'] ?>" title="<?= $row['Song_name'] ?>"></a>

								<a name="<?= $row['path'] ?>"  href="#"><?= $row['Song_name'] ?></a>
							</div>

						<?php }  ?>
<!-- 								<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" id="pos" href="#"><img src="images/v1.jpg" title="allbum-name"></a>
								<a class="button play-icon popup-with-zoom-anim" name="media/Georgia.mp3" href="#">Listen now</a>
							</div>
							<div id=#" class="mfp-hide">
								<iframe src="https://player.vimeo.com/video/12985622"></iframe>
								
							</div>
							<div class="col-md-3 content-grid">
								<a class="play-icon popup-with-zoom-anim" id="pos" href="#"><img src="images/v2.jpg" title="allbum-name"></a>

								<a class="button play-icon popup-with-zoom-anim" name="media/Blue Browne.mp3" href="#">Listen now</a>
							</div> -->
<!-- ---------------------------------------------------------------- -->						
					...
					<!--//End-albums-->
						...
						<div class="albums second">
										<div class="tittle-head">
											...
											<a href="Tuneup.php"><h4 class="tittle two">See all</h4></a>
											<div class="clearfix"> </div>
										</div>
											<div class="col-md-3 content-grid">
				...
				$(document).ready(function(){
					...
					new jPlayerPlaylist({
						...
						
						{
							...
							artist:"",
							mp3: "media/01 - Tum Hi Ho - Arijit Singh [DJMaza.Life].mp3",
							// ogv: "video/Ellie-Goulding.ogv",
							// webmv: "video/Ellie-Goulding.webm",
							poster:"images/ari.jpg"
						},
						{
			...
			<!-- //script for play-list -->
								...
								<!--/app_store-->
									  <div class="apps">
												<h3 class="hd-tittle">Tuneup now available in</h3>
											...
											<div class="pricing-inner">
												...
												<div class="pricing">
													...
													<div class="price-bottom">
														...
														<a href="payment.php" class="price">Upgrade</a>
													</div>
												</div>
