...
<!-- ----------------------------------------------------------------------								 -->
						...
						<?php 
							...
							?>
								<div class="col-md-3 browse-grid">
									<a  href="single.php?id=<?= $row['Album_ID']?>"><img src="<?= $row['image'] ?>" title="<?= $row['Album_name'] ?>"></a>
									 <a href="single.php?id=<?= $row['Album_ID']?>"><i class="glyphicon glyphicon-play-circle"></i></a>
									<a class="sing" href="single.php?id=<?= $row['Album_ID'] ?>">"<?= $row['Album_name'] ?>"</a>
								</div>
							<?php } ?>
					...
					<!--//End-albums-->
						...
						<div class="review-slider">
								...
								?>
									<li>
										<a href="single.php"><img src="<?= $row2['image'] ?>" alt=""/></a>
										<div class="slide-title"><h4><?= $row2['Album_name'] ?></h4></div>
										<div class="date-city">
											<h5>Jan-02-16</h5>
							...
							<?php } ?>
								...
								<li>
									<a href="single.php"><img src="" alt=""/></a>
