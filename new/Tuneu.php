    ...
    <section>
      <!-- left side start-->
		<div class="left-side sticky-left-side">
			...
			<div class="logo">
				<h1><a href="index.html">♪ <span>TuneUp</span></a></h1>
			</div>
							  ...
							  <!-- search-scripts -->
									...
									<!-- //search-scripts -->
											...
											<div class="col-md-4 login-pop">
												<div id="loginpop"> <a href="#" id="logoutButton"><span>Logout <i class="arrow glyphicon glyphicon-chevron-right"></i></span></a><a class="top-sign" href="login.php"></a>
												</div>
											</div>
