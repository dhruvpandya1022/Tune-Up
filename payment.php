...
<!--								<div id="sb-search" class="sb-search">
			...
			<div class="container">
				...
				<div>&nbsp;</div>
			<div>&nbsp;</div>
				<form action="Tuneup.php" method="POST">
					<input type="radio" name="payment" value="debit card">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/mastercard.png">&nbsp;&nbsp;&nbsp;&nbsp;Debit Card
					<br>
					<div>&nbsp;</div>
			<div>&nbsp;</div>
					<input type="radio" name="payment" value="Visa card">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/visa.png">&nbsp;&nbsp;&nbsp;&nbsp;Visa Card
					<br>
					<div>&nbsp;</div>
			<div>&nbsp;</div>
					<input type="radio" name="payment" value="Googlepay">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/Googlepay.png">&nbsp;&nbsp;&nbsp;&nbsp;Google pay
					<br>
					<div>&nbsp;</div>
			<div>&nbsp;</div>
					<input type="radio" name="payment" value="paypal">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/paypal.png">&nbsp;&nbsp;&nbsp;&nbsp;Paypal
					<br>
					<div>&nbsp;</div>
			<div>&nbsp;</div>
					<input type="radio" name="payment" value="paytm">&nbsp;&nbsp;&nbsp;&nbsp;<img src="images/paytm.png">&nbsp;&nbsp;&nbsp;&nbsp;Paytm
					<br>
					<div>&nbsp;</div>
			<div>&nbsp;</div>
